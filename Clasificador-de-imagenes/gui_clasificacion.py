...
import gradio as gr
from Clasificacion import main
...
#Armar la GUI
demo = gr.Interface(fn=main, inputs=[image4,image3,image2,image1] , outputs=[text4, text3,text2,text1,text5],title=title,description=description,article=article)
